...
class WebkitPony(gtk.Window):
    ...
    def __init__(self, settings):
        ...
        if getattr(settings, 'SCROLLABLE', True):
            scrollwindow = gtk.ScrolledWindow()
            scrollwindow.props.hscrollbar_policy = gtk.POLICY_AUTOMATIC
            scrollwindow.props.vscrollbar_policy = gtk.POLICY_AUTOMATIC
            scrollwindow.add(self.webgui)
        ...
        if settings.DEBUG:
            ...
            self.webgui.props.settings.props.enable_default_context_menu = False
...
class PonyWebView(webkit.WebView):
    ...
    def __init__(self, settings):
        ...
        if hasattr(self.settings, 'URLCONF'):
